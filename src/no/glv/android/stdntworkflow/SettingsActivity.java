 ...
 * handset devices, settings are presented
 * as a single list. On tablets, settings are split by category, with category
 * headers shown to the left of the list of
 * settings.
 * <p>
...
public class SettingsActivity extends PreferenceActivity {
	 ...
	 * settings are presented in a single list. When
	 * false, settings are shown as a master/detail two-pane view on tablets.
	 * When true, a single pane is shown on
	 * tablets.
	 */
	 ...
	 * device configuration dictates that a
	 ...
	 * doesn't have newer APIs like {@link PreferenceFragment}, or the
	 * device doesn't have an extra-large screen. In these cases, a single-pane
	 * "simplified" settings UI should be
	 * shown.
	 */
	 ...
	 * preference's value is changed, its summary
	 * (line of text below the preference title) is updated to reflect the
	 * value. The summary is also immediately
	 ...
	 * activity is showing a two-pane settings
	 * UI.
	 */
	@TargetApi(Build.VERSION_CODES.HONEYCOMB)
