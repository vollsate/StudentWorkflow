 ...
 * 
 * - The user may look at a class or a task - A new task may be loaded - A new class may be installed
 * 
...
public class MainActivity extends Activity {
	...
	if ( forceReplace ) startClassesFragment( forceReplace );
	...
	FragmentTransaction tr = getFragmentManager().beginTransaction();
	if ( replace ) tr.replace( R.id.FR_installedClasses_container, classesFragment ).commit();
	else
